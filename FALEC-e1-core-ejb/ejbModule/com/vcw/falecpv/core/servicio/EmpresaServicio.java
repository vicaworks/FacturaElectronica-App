...
//				empresa.setClavefirmaelectronica(UtilMd5.hash(empresa.getClavefirmaelectronica()));
	...
	public void parametrosGenericos(String idEmpresa)throws DaoException{
		try {
			...
			parametroList.add(new ParametroGenericoEmpresa("24", idEmpresa, null, "PLANTILLA_EMAIL_COTIZACION", "-", "PLANTILLA EMAIL COTIZACION"));
			...
			parametroList.add(new ParametroGenericoEmpresa("30", idEmpresa, null, "PLANTILLA FACTURA PUNTO VENTA", "-", "PLANTILLA COMPROBANTE ELECTRONICO"));
