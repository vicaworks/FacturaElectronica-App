...
/**
 * @author vcwdesarrollo
 *
 */
@FacesValidator("letrasEspacioComas")
public class LetrasEspacioComas implements Validator {

	/**
	 * 
	 */
	public LetrasEspacioComas() {
	}
	...
	public void validate(FacesContext arg0, UIComponent arg1, Object arg2)
		...
		try {
			for (int i = 0; i < valores.length; i++) {
				ExpresionRegularValidador.validarSoloLetrasEspacio(valores[i]);
			}
