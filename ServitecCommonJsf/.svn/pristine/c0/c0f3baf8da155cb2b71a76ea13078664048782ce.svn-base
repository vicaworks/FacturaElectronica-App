 ...
 *
 */
@FacesValidator("letrasEspacioValidator")
public class LetrasEspacioValidator implements Validator {

	/**
	 * 
	 */
	public LetrasEspacioValidator() {
	}
	...
	public void validate(FacesContext arg0, UIComponent arg1, Object arg2)
		...
		try {
			ExpresionRegularValidador.validarSoloLetrasEspacio(valor);
