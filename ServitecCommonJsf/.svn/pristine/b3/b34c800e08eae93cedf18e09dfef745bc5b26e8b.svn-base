 ...
 *
 */
@FacesValidator("numerosDecimalesPuntoValidator")
public class NumerosDecimalesPuntoValidator implements Validator {

	/**
	 * 
	 */
	public NumerosDecimalesPuntoValidator() {
	}
	...
	public void validate(FacesContext arg0, UIComponent arg1, Object arg2) throws ValidatorException {
		...
		if (arg2 == null || ((String) arg2).trim().length() == 0)
			return;

		String valor = (String) arg2;

		try {
			ExpresionRegularValidador.validarSoloNumerosDecimalesPunto(valor);
