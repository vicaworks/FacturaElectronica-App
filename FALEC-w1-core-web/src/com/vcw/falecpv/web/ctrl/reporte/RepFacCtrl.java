...
@Named
@ViewScoped
public class RepFacCtrl extends BaseCtrl {
	...
	private void consultar()throws DaoException {
		...
		ventasQueryList = consultaVentaServicio.getFacturasEmitidas(null,ComprobanteEstadoEnum.REGISTRADO,criterioBusqueda, desde, hasta, AppJsfUtil.getEstablecimiento().getIdestablecimiento(),GenTipoDocumentoEnum.FACTURA);
	}
	...
	public StreamedContent getFile() {
		try {
			...
			String path = FacesUtil.getServletContext().getRealPath(
					AppConfiguracion.getString("dir.base.reporte") + "FALECPV-FacEmitidasres.xlsx");
			...
			return AppJsfUtil.downloadFile(tempXls, "FALECPV-FacEmitidasRes-" +  AppJsfUtil.getEstablecimiento().getNombrecomercial() + ".xlsx");
		} catch (Exception e) {
			e.printStackTrace();
			AppJsfUtil.addErrorMessage("formMain2", "ERROR", TextoUtil.imprimirStackTrace(e, AppConfiguracion.getInteger("stacktrace.length")));
		}
