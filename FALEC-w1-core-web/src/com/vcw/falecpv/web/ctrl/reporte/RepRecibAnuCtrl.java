...
public class RepRecibAnuCtrl extends BaseCtrl {
	...
	private void consultar()throws DaoException {
		...
		ventasQueryList = consultaVentaServicio.getFacturasEmitidas(usuarioSelected,ComprobanteEstadoEnum.ANULADO, criterioBusqueda, desde, hasta, AppJsfUtil.getEstablecimiento().getIdestablecimiento(),GenTipoDocumentoEnum.RECIBO);
	}
